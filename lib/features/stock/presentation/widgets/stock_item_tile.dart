...
class StockItemTile extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final themeColor =
        isOutOfStock ? kBorderError : (isLowStock ? Colors.orange : kPrimary);
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: isOutOfStock
            ? Border.all(color: kBorderError.withOpacity(0.3), width: 1)
                      ...
                      Row(
                        children: [
                          _ActionPill(
                            ...
                            onPressed: stock.qty > 0
                                ? () => _decreaseQty(context, ref)
                                : null,
  ...
  Future<void> _increaseQty(BuildContext context, WidgetRef ref) async {
    ...
    try {
      await ref
          ...
          .updateStockQty(stock.id, stock.qty + 1, performer: performer);
  ...
  Future<String?> _showPerformerDialog(
            ...
            children: [
              ...
              Expanded(
                child: ElevatedButton(
                  ...
                  onPressed: () async {
                    try {
                      await ref.read(stockListProvider.notifier).deleteStock(stock.id, performer: 'System');
